...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 class="section-title">Catory</h3>
...
?>
		...
		<div class="item">
				<div class="pro">
					<div class="image">
						<a href="product-details.php?pid=<?php echo htmlentities($rws['id']);?>"><img  src="admin/productimages/<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage1']);?>"  width="200" height="250"></a>
				</div>
                <div class="des">
                    	<h5><a href="product-details.php?pid=<?php echo htmlentities($rws['id']);?>"><?php echo htmlentities($rws['productName']);?></a></h5>
                    	...
                    	<div class="product-price">	
							...
							<span class="price-before-discount">Rs.<?php echo htmlentities($rws['productPriceBeforeDiscount']);?>
							</span>
					</div>
                </div>
				
					<?php if($rws['productAvailability']=='In Stock'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $rws['id']; ?>" ><i class="ri-shopping-cart-2-fill cart text-center"></i></a></div>
				<?php } else {?>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	?>	
		...
		<div class="pro">
					<div class="image">
						<a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="admin/productimages/<?php echo htmlentities($rw['id']);?>/<?php echo htmlentities($rw['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($rw['id']);?>/<?php echo htmlentities($rw['productImage1']);?>"  width="200" height="250"></a>
				</div>
                <div class="des">
                    	<h5><a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><?php echo htmlentities($rw['productName']);?></a></h5>
                    	<div class="rating rateit-small"></div>
                    	<div class="product-price">	
							...
							<span class="price-before-discount">Rs.<?php echo htmlentities($rw['productPriceBeforeDiscount']);?>
							</span>
					</div>
                </div>
				
					<?php if($rw['productAvailability']=='In Stock'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $rw['id']; ?>" ><i class="ri-shopping-cart-2-fill cart text-center"></i></a></div>
				<?php } else {?>
						<div class="action" style="color:red">Out of Stock</div>
					<?php } ?>
